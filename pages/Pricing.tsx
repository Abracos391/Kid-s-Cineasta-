...
const Pricing: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <h1 className="font-comic text-5xl text-center text-cartoon-green text-stroke-black mb-16">
        Planos e Pacotes 💎
      </h1>
      ...
      <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
        ...
        <div className="transform -rotate-1">
            <Card color="white" className="h-full flex flex-col relative opacity-80">
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-gray-200 px-4 py-1 rounded-full border-2 border-black font-bold">
                    Básico
                </div>
                <h2 className="font-heading text-4xl text-center mb-4">Aventureiro</h2>
        ...
        <div className="transform rotate-1 hover:scale-105 transition-transform z-10">
            <Card color="yellow" className="h-full flex flex-col relative shadow-xl border-4 border-black">
                 <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-cartoon-pink text-white px-6 py-2 rounded-full border-2 border-black font-comic text-xl animate-pulse">
                    RECOMENDADO
                </div>
                <h2 className="font-heading text-4xl text-center mb-4 text-purple-600">Cineasta PRO</h2>
                <div className="text-center mb-8">
                    <span className="text-5xl font-comic">R$ 19,90</span>
                    <span className="font-bold block text-sm">Pacote de 5 Histórias</span>
                </div>
